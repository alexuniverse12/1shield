...
import { OneInchQuote } from '../../api/one-inch/one-inch-quote';
import { OneInchSwapStep } from '../../steps/swap/one-inch/one-inch-swap-step';
import {
  RecipeConfig,
  RecipeERC20Amount,
  RecipeERC20Info,
...
export class OneInchSwapRecipe extends SwapRecipe {
  ...
  async getSwapQuote(
    ...
    return OneInchQuote.getSwapQuote(quoteParams);
  }
  ...
  protected async getInternalSteps(
    ...
    return [
      ...
      new OneInchSwapStep(this.quote, this.sellERC20Info),
    ];
  }
}
